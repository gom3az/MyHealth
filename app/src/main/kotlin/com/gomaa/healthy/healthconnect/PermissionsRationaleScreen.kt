...
fun PermissionsRationaleScreen(
    onAccept: () -> Unit, onDecline: () -> Unit, modifier: Modifier = Modifier
) {
    Column(
        modifier = modifier
            .fillMaxSize()
        ...
        Column {
            Text(
                text = "Privacy & Permissions", style = MaterialTheme.typography.headlineMedium
            )
            ...
            Spacer(modifier = Modifier.height(Dimensions.spacingLarge))
            Text(
                text = "Data Types Accessed:", style = MaterialTheme.typography.titleMedium
            )
            Spacer(modifier = Modifier.height(Dimensions.spacing))
            Text(
        ...
        Column {
            Button(
                onClick = onAccept, modifier = Modifier.fillMaxSize()
            ) {
                Text("Continue")
            }
            Spacer(modifier = Modifier.height(Dimensions.spacing))
            OutlinedButton(
                onClick = onDecline, modifier = Modifier.fillMaxSize()
            ) {
                Text("Cancel")
            }
        }
